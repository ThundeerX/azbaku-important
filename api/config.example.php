...
//       'editor' = yalnız səhifə mətnləri (header, footer, ana səhifə, haqqımızda,
//                  sifariş ver, nümunələr) — kalkulyator tariflərinə TOXUNA BİLMƏZ
...
define('AB_USERS', json_encode([
    ...
    'azbaku' => ['pass' => 'AZBAKU_SIFRESI',  'role' => 'editor', 'name' => 'Azbaku']
]));
