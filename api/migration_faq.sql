...
('Ümumi xərclərə nələr daxildir?','Что входит в общие расходы?','Auksion qiyməti, buyer fee, daxili daşınma ($250), dəniz daşınma, sığorta, gömrük.','Цена лота, комиссия аукциона, доставка по США ($250), морская доставка, страховка, таможня.','price',1),
